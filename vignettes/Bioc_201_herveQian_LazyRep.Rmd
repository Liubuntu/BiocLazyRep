...
- Knowledge of the `DelayedArray` class
...
```{r, GDSread}
readex.gdsn(index.gdsn(g1, "sample.id"), 1:5)
aperm(readex.gdsn(index.gdsn(g1, "genotype/data"), list(1, 1:5, 1:5)), c(3,2,1))
closefn.gds(g1)
```

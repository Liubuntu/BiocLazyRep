...
| `anyNA`, `which` | |
| `unique`, `table` | |
| All the members of the `Summary` group | e.g. `max`, `sum`, `all`, etc... |
| `mean` | |
| `apply` | |
...
matrixStats package and the methods for DelayedMatrix objects are implemented
in the [DelayedMatrixStats package](https://bioconductor.org/packages/DelayedMatrixStats).
